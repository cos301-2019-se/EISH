...
public class GeneratorEndPointController{
    ...
    */
    ...
    //@PreAuthorize("hasRole('RESIDENT') or hasRole('ADMIN') or hasRole('GUEST')")
    public ResponseEntity<Generator> retriveGenerator(@Valid @RequestParam(value = "generatorId") long generatorId){
     ...
     * @return
     */
    @GetMapping(value = "/generator/state")
    @PreAuthorize("hasRole('RESIDENT') or hasRole('ADMIN') or hasRole('GUEST')")
    public List<Object> getGeneratorStates() {
       return null;
    }
     ...
     * @return device state
     */
    @PatchMapping("/generator/{generatorId}/{generatorState}")
    @PreAuthorize("hasRole('ADMIN') or hasRole('RESIDENT') or hasRole('GUEST')")
    public ResponseEntity<Object> controlDevice(@PathVariable long generatorId, @PathVariable String generatorState) {
       return null;
    }
