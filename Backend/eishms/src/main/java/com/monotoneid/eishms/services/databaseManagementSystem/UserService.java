...
public class UserService{
    ...
    public ResponseEntity<Object> addUser(HomeUser homeUser) {
        try {
            ...
            if (homeUser.getUserName() != null && homeUser.getUserEmail() != null 
                    && homeUser.getUserPassword() != null 
                    && homeUser.getUserLocationTopic() != null 
                    && homeUser.getUserType() != null 
                    && homeUser.getUserExpiryDate() != null) {
     ...
     * @param homeUserName represents uers name
     * @return HomeUser
     * @exception ResourceNotFound
     */
    public ResponseEntity<HomeUser> retrieveUser(String homeUserName) {
        try {
            HomeUser foundUser = usersRepository.findByHomeUserName(homeUserName)
    ...
    public ResponseEntity<Object> updateUserType(long userId, String role) {
        try {            
            ...
            if (e.getCause() == null) {
                return new ResponseEntity<>("Error: Failed to update user type!",
