...
public interface HomeConsumptions extends JpaRepository<HomeConsumption,Long> {
    ...
    public Optional<List<HomeConsumption>> findByHomeConsumptionTimestampBetween(Timestamp startTimeStamp,Timestamp endTimeStamp);
     ...
     //quick ranges
    //last 10 minutes
    @Query(value="select * from homeconsumption where homeconsumptiontimestamp between now() - interval '10 minutes' and now() order by homeconsumptiontimestamp asc", nativeQuery = true)
    public Optional<List<HomeConsumption>> findHomeConsumptionLastTenMinutes();

    //last 1 hours
    @Query(value="select * from homeconsumption where homeconsumptiontimestamp between now() - interval '1 hours' and now() order by homeconsumptiontimestamp asc", nativeQuery = true)
    public Optional<List<HomeConsumption>> findHomeConsumptionLastHour();

    //last  1 day
    @Query(value="select * from homeconsumption where homeconsumptiontimestamp between now() - interval '1 days' and now() order by homeconsumptiontimestamp asc", nativeQuery = true)
    public Optional<List<HomeConsumption>> findHomeConsumptionLastOneDay();

    //last 1 week
    @Query(value="select * from homeconsumption where homeconsumptiontimestamp between now() - interval '1 weeks' and now() order by homeconsumptiontimestamp asc", nativeQuery = true)
    public Optional<List<HomeConsumption>> findHomeConsumptionLastOneWeek();

    //last 1 month
    @Query(value="select * from homeconsumption where homeconsumptiontimestamp between now() - interval '1 months' and now() order by homeconsumptiontimestamp asc", nativeQuery = true)
    public Optional<List<HomeConsumption>> findHomeConsumptionLastOneMonth();

    //last 1 year
    @Query(value="select * from homeconsumption where homeconsumptiontimestamp between now() - interval '1 years' and now() order by homeconsumptiontimestamp asc", nativeQuery = true)
    ...
    //total month
    @Query(value = "select sum(homeconsumption) from homeconsumption where homeconsumptiontimestamp between now() - interval '1 months' and now()", nativeQuery = true)
    public Float findTotalHomeConsumptionMonth();

    //total day
    @Query(value = "select sum(homeconsumption) from homeconsumption where homeconsumptiontimestamp between now() - interval '1 days' and now()", nativeQuery = true)
    public Float findTotalHomeConsumptionDay();

    //total week
    @Query(value = "select sum(homeconsumption) from homeconsumption where homeconsumptiontimestamp between now() - interval '1 weeks' and now()", nativeQuery = true)
    public Float findTotalHomeConsumptionWeek();
